...
/// Storage with persistence via SharedPreferences.
...
class Storage {
  ...
  // ============================================================
  // Initialization - load persisted data into memory
  // ============================================================

  static Future<void> init() async {
    _prefs = await SharedPreferences.getInstance();
    // Load persisted data into memory
    for (final key in [_keyPlans, _keyRecords, _keySettings, _keyStats]) {
