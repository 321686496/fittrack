...
class _TrainingPageState extends State<TrainingPage> {
  ...
  /// 休息结束时振动提醒
  Future<void> _vibrateOnRestEnd() async {
    try {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text(a['icon'] as String, style: const TextStyle(fontSize: 56)),
              const SizedBox(height: 16),
              Text('恭喜达成成就！', style: TextStyle(color: colors.accentGlow, fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Text(a['name'] as String, style: TextStyle(color: colors.textPrimary, fontSize: 22, fontWeight: FontWeight.bold)),
              const SizedBox(height: 6),
              Text(a['desc'] as String, style: TextStyle(color: colors.textSecondary, fontSize: 14), textAlign: TextAlign.center),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    _showAchievementSequence(achievements, index + 1);
                  },
