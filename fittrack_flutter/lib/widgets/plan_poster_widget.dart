  ...
  Widget _buildHeader() {
    return Row(
      children: [
        ...
        const Text('LiftTrack', style: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold)),
        const Spacer(),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text('在 LiftTrack App 中导入即可使用', style: TextStyle(color: Colors.white.withOpacity(0.4), fontSize: 14)),
              ],
            ),
          ),
        ],
